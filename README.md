...
dependencies {
  ...
  implementation("io.github.droibit.oss-licenses-android:ui-wear-compose-material:0.10.0")
  // or
  // If using `androidx.wear.compose:compose-material3`
  implementation("io.github.droibit.oss-licenses-android:ui-wear-compose-material3:0.10.0")

  // For custom implementations, use only the parser
  implementation("io.github.droibit.oss-licenses-android:parser:0.10.0")
}
```
